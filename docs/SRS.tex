...
\hline
See driver badges & As a passenger, I should be able to see the badges my driver have. & Given I have started my ride, then I should see my driver's badges. \\
& & Badges appear on the page where the passenger is once the ride has started. \\
\hline
Front Passenger & As a front passenger, I should be able to see who owes the driver money and who the driver owes money. & Given I am the front passenger, then I should see the money owed to the driver and they money owed to a passenger. \\
& & This page appears for the front passenger once the driver sets them as the front passenger. \\
\hline
Book a Seat and Get Confirmation for Multi-Leg Journey & As a passenger, I want to book a seat on multiple taxi's and receive confirmation, so that I’m guaranteed a spot before the taxi's arrives. & Given I’ve selected a taxi, I should be taken to a screen that shows me multiple multi-leg routes to choose from, Then I should receive a booking confirmation and a ride status update once the first leg driver has accepted. Once the first leg is completed, the same process should happen for the second leg. \\
& & A booking confirmation message appears with the selected taxi details and current ride status for both legs. \\
\hline
...
\hline
See passenger badges & As a driver, I should be able to see the badges of my passengers. & Given I have passengers on my ride, then I should see the passenger's badges. \\
& & Badges appear on the page where the active rides are. \\
\hline
See Money Owed & As a driver, I should be able to see who owes me money and who I owes money. & Given I am the driver, then I should see the money owed to me and they money owed to a passenger. \\
& & This page appears for the driver under all their statistics. \\
\hline
Set Front Passenger & As a driver, I should be able to set a front passenger who can see certain ride details. & Given I am the driver, then I should be able to set a front passenger. \\
& & This functionality appears under the active rides page. \\
\hline
...
\begin{itemize}
    ...
    \item R3.6: Passengers should be able to make a multi-leg (max 2 legs) ride request.
\end{itemize}
...
\begin{itemize}
    ...
    \item R10.4: The driver should be able to see unpaid trips.
    \item R10.5: The driver should be able to see who owes them money and who they owe change.
    \item R10.6: The driver should be able to indicate who their front passenger is.
    \item R10.7: The front passenger should be able to see who owed the driver money and who needs change from the driver.
\end{itemize}
...
\subsection*{R13: Badges Features}
\begin{itemize}
    \item R13.1: Passengers should be able to see their own badges on their profile page.
    \item R13.2: Drivers should be able to see their own badges on their profile page.
    \item R13.3: Passengers should be able to see the badges of the driver they choose.
    \item R13.4: Drivers should be able to see the badges of passengers on their ride.
\end{itemize}
