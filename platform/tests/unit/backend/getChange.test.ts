...
describe("rides change handlers", () => {
  let ctx: any;
  ...
  describe("getChangeDueRides", () => {
    ...
    it("filters out rides with exact payment", async () => {
      const ride = {
        _id: "r1",
        passengerId: "u1",
        finalFare: 100,
