// screens/DriverNotificationSettings.tsx
...
export default function DriverNotificationSettings() {
  ...
  // Query current notification settings (reusing the same function)
  ...
  // Mutation to update settings (reusing the same function)
      ...
      <View style={dynamicStyles.container}>
        ...
        <View style={dynamicStyles.section}>
          <SettingItem
            ...
            description="Receive ride requests, earnings updates, and other important driver notifications"
