...
export default function TaxiInformation() {
  ...
  return (
    <View style={dynamicStyles.container}>
      ...
      {/* Multi-leg journey information */}
      {isMultiLeg === 'true' && getNextLegStatus?.hasNextLeg && (
        <View style={dynamicStyles.secondLegInfo}>
          <View style={dynamicStyles.secondLegHeader}>
            ...
            <Text style={dynamicStyles.secondLegTitle}>Next Leg Available</Text>
          </View>
          <Text style={dynamicStyles.secondLegRoute}>
            Continue your multi-leg journey
          </Text>
          <View style={dynamicStyles.secondLegDetails}>
            <Text style={dynamicStyles.secondLegFare}>
              Leg {parseInt(currentLegIndex || '0') + 2} of {totalLegs}
            </Text>
          ...
          <View style={dynamicStyles.routeInfoCard}>
            <View style={dynamicStyles.routeHeader}>
              ...
              <Text style={dynamicStyles.routeText}>
                {originalCurrentName || currentName || 'Current Location'}
              </Text>
            </View>
            <View style={dynamicStyles.routeHeader}>
              <View style={dynamicStyles.routeIndicator}>
              ...
              <Text style={dynamicStyles.routeText}>
                {originalDestinationName || destinationName || 'Destination'}
              </Text>
            </View>
