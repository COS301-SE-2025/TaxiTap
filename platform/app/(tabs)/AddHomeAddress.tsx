...
export default function AddHomeAddress() {
    ...
    const translations: Record<string, Record<SupportedLanguage, string>> = {
        ...
        homeAddressSaved: {
            en: "Home address saved successfully!",
            zu: "Ikheli lekhaya lisindisiwe ngempumelelo!",
            tn: "Aterese ya ntlo e bolokilwe ka katlego!",
            af: "Tuis adres suksesvol gestoor!"
        },
        failedToSaveAddress: {
        ...
        deleteHomeAddress: {
            en: "Delete Home Address",
            zu: "Susa Ikheli Lekhaya",
            tn: "Tlosa Aterese ya Ntlo",
            af: "Skrap Tuis Adres"
        },
        deleteAddressConfirm: {
            en: "Are you sure you want to delete your home address?",
            zu: "Uqinisekile ukuthi ufuna ukususa ikheli lakho lekhaya?",
            tn: "O kgotsofala gore o batla go tlosa aterese ya gago ya ntlo?",
            af: "Is jy seker jy wil jou tuis adres skrap?"
        },
        homeAddressDeleted: {
            en: "Home address deleted successfully!",
            zu: "Ikheli lekhaya lisusiwe ngempumelelo!",
            tn: "Aterese ya ntlo e tlosiwe ka katlego!",
            af: "Tuis adres suksesvol geskrap!"
        },
        ...
        editHomeAddress: {
            en: "Edit Home Address",
            zu: "Hlela Ikheli Lekhaya",
            tn: "Fetola Aterese ya Ntlo",
            af: "Wysig Tuis Adres"
        },
        addHomeAddress: {
            en: "Add Home Address",
            zu: "Engeza Ikheli Lekhaya",
            tn: "Tsenya Aterese ya Ntlo",
            af: "Voeg Tuis Adres By"
        },
        addressInformation: {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            showGlobalSuccess(
                ...
                getTranslation('homeAddressSaved'),
                { duration: 2000 }
            );
            setTimeout(() => {
    ...
    const handleDelete = async () => {
        ...
        showConfirm(
            getTranslation('deleteHomeAddress'),
            ...
            async () => {
                try {
                    ...
                    showGlobalSuccess(
                        getTranslation('success'),
                        getTranslation('homeAddressDeleted'),
                        { duration: 2000 }
                    );
                    setTimeout(() => {
                        router.push('/(tabs)/PassengerProfile');
            ...
            >
                ...
                <View style={dynamicStyles.header}>
                    ...
                    <Text style={dynamicStyles.headerTitle}>
                        {hasExistingAddress ? getTranslation('editHomeAddress') : getTranslation('addHomeAddress')}
                    </Text>
                </View>
